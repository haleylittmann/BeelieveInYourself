...
OFILES = gba.o font.o logic.o graphics.o main.o images/shaymin_superwin.o images/garbage.o images/garbage.o images/startscreentext.o images/winningscreen.o images/losingscreen.o images/bee.o images/shaymin.o images/flower.o images/control_adv.o
